...
public class Fines extends JFrame
{
	...
	void prepareGUI()
	{
		...
		header.setFont(new Font("Arial Black",Font.BOLD,20));
                header.setForeground(Color.green.darker().darker());
		...
		//Borrower Card No.
		JLabel lblcard=new JLabel("Card ID.*  :",JLabel.LEFT);
                
                lblcard.setFont(new Font("Arial Black",Font.BOLD,14));
                lblcard.setBackground(Color.black);
                lblcard.setForeground(Color.orange);
		...
		cardText.setFont(new Font("Arial Black",Font.BOLD,14));
		...
		JButton finesDue=new JButton("ALL FINES DUE");
                ...
                finesDue.setFont(new Font("Arial Black",Font.BOLD,14));
                finesDue.setBackground(Color.orange);
                finesDue.setForeground(Color.white);
		...
		JButton paidFines=new JButton("PAID FINES");
                ...
                paidFines.setFont(new Font("Arial Black",Font.BOLD,14));
                paidFines.setBackground(Color.orange);
                paidFines.setForeground(Color.white);
		//checkOut.setLocation(50, 50);
		...
		JButton totalDue=new JButton("TOTAL AMOUNT DUE");
                ...
                totalDue.setFont(new Font("Arial Black",Font.BOLD,14));
                totalDue.setBackground(Color.orange);
                totalDue.setForeground(Color.white);
		//checkOut.setLocation(50, 50);
