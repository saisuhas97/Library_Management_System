...
public class Search extends JFrame
{
	...
	void prepareGUI() throws SQLException
	{
		...
		JLabel searchLabel=new JLabel("BOOK SEARCH",JLabel.CENTER);
                searchLabel.setFont(new Font("Calibri",Font.BOLD,24));
		searchLabel.setForeground(Color.green.darker().darker());
