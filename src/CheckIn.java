...
public class CheckIn extends JFrame
{
	...
	void prepareGUI()
	{
		...
		lblIsbn.setFont(new Font("Arial Black",Font.BOLD,14));
                
                lblIsbn.setBackground(Color.black);
                lblIsbn.setForeground(Color.orange);
		...
		isbnText.setFont(new Font("Ariel",Font.BOLD,14));
		...
		//Borrower Card No.
		JLabel lblcard=new JLabel("           Card ID. :",JLabel.RIGHT);
		...
		lblBorrower.setFont(new Font("Arial Black",Font.BOLD,14));
                
                
                lblBorrower.setBackground(Color.white);
                lblBorrower.setForeground(Color.orange);
		...
		borrowerText.setFont(new Font("Ariel Black",Font.BOLD,14));
