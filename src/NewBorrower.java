...
public class NewBorrower extends JFrame
{
	...
	void prepareGUI()
	{
		...
		lblHeader.setFont(new Font("Arial Black",Font.BOLD,20));
                lblHeader.setForeground(Color.green.darker().darker());
		...
		lblFName.setFont(new Font("Arial Black",Font.BOLD,14));
                lblFName.setBackground(Color.white);
                lblFName.setForeground(Color.orange);
		...
		fNameText.setFont(new Font("Arial Black",Font.PLAIN,14));
		...
		lblLName.setFont(new Font("Arial Black",Font.BOLD,14));
                lblLName.setBackground(Color.white);
                lblLName.setForeground(Color.orange);
		...
		lNameText.setFont(new Font("Arial Black",Font.PLAIN,14));
		...
		lblSsn.setFont(new Font("Arial Black",Font.BOLD,14));
                lblSsn.setBackground(Color.white);
                lblSsn.setForeground(Color.orange);
		...
		ssnText.setFont(new Font("Arial Black",Font.BOLD,14));
		...
		emailText.setFont(new Font("Arial Black",Font.BOLD,14));
		...
		lblAddress.setFont(new Font("Arial Black",Font.BOLD,14));
		...
		addressText.setFont(new Font("Arial Black",Font.BOLD,14));
		...
		cityText.setFont(new Font("Arial Black",Font.BOLD,14));
		...
		lblState.setFont(new Font("Arial Black",Font.BOLD,14));
		...
		stateText.setFont(new Font("Arial Black",Font.PLAIN,14));
		...
		phoneText.setFont(new Font("Arial Black",Font.PLAIN,14));
		...
		gbc_space1.insets=new Insets(5,0,5,0);
		gbc_space1.gridx=0;
		gbc_space1.gridy=5;
		...
		newBorrower.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e) 
			{
				try{
					...
					if(fNameText.getText().equals("") &&ssnText.getText().equals("")&&addressText.getText().equals("") &&phoneText.getText().equals("") )
					{
					...
					if(ssn.length()<9)
					{
						...
						conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/library", "root", "saisuhas97");
						...
						stmt3.executeUpdate("Insert into library.borrower(Card_id,Ssn,Bname,Address,Phone) values("+id+","+ssn+",'"+fName+"','"+address+"',"+phone+");");
						fNameText.setText("");
						//lNameText.setText("");
						ssnText.setText("");
						//emailText.setText("");
		...
		gbc_newBorrower.insets = new Insets(5, 0, 5, 0);
		...
		gbc_space2.insets=new Insets(5,0,5,0);
		gbc_space2.gridx=0;
		gbc_space2.gridy=7;
