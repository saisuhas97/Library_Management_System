...
public class CheckOut extends JFrame
{
	...
	void prepareGUI()
	{
		...
		JLabel lblIsbn=new JLabel("     Isbn* :",JLabel.LEFT);
                ...
                lblIsbn.setBackground(Color.orange);
		...
		isbnText.setFont(new Font("Arial Black",Font.BOLD,14));
                isbnText.setBackground(Color.white);
		...
		lblcard.setFont(new Font("Arial Black",Font.BOLD,14));
                lblcard.setBackground(Color.orange);
